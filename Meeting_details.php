      ...
      <h4>New Meeting<h4>
        <form>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="Topic" value="EE Project" disabled="true">
            </div>
            <label for="" class="col-sm-2 col-form-label">Owner:</label>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              ...
              <textarea class="form-control" rows="5" id="comment" disabled="true">
 Stand Up Meeting 
              </textarea>

            </div>
            <label for="" class="col-sm-2 col-form-label">Attendees:</label>
            <div class="form-group col-sm-4">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="Topic" value="22-12-2018" disabled="true">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="Topic" value="10.00 AM" disabled="true">
          </div>
          <label for="" class="col-sm-2 col-form-label">End Time:</label>
          <div class="col-sm-4">
            <input type="text" class="form-control" id="Topic"value="11.00 AM" disabled="true">
          </div>
        </div>
