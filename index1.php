...
<table class="table">
  ...
  <tbody>
    <tr>
      <th scope="row">12-05-2018</th>
      <td><a href="Training_details.php">SDLC Software Training</a></td>
      <td>John Miller</td>
      <td>
      <div class="row">
    <div class="col-sm-12 text-center">
       <a href="ManageTrainingDetails.php" class="btn btn-success btn-sm " role="button" aria-pressed="true">RSVP</a>
       <a href="ManageTrainingDetails.php" class="btn btn-primary btn-sm " role="button" aria-pressed="true">Manage</a>
     </div>
</div>
